...
namespace DAL.MongoBase
{
    ...
    // Ödeme yapmamıza imkan sağlayan base repositorymiz
    // Alt yapı oluşturması adına CRUD işlemlerinin tamamı eklendi
    // ancak ihtiyaç duyulmayanların  controller bağlantısı yapılması.
